  ...
  <v-container>
    ...
    <v-row>
      ...
      <v-col dark offset = "1" cols = "10">
        <v-alert type = "success" dismissible v-model = "bSuccess">Reset mail was sent to your account!</v-alert>
        <v-alert type = "error" dismissible v-model = "bError">{{bErrMsg}}</v-alert>
      </v-col>
    </v-row>
  </v-container>
</template>
